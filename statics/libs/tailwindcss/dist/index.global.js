...
;(() => {
  ...
  function Se(t, r) {
    ...
    for (let p = 0; p < t.length; p++) {
      ...
      if (!(v === Ye && ((g = t.charCodeAt(p + 1)), g === ne)))
        if (v === Pe) u === '' && (m = p), (u += t.slice(p, p + 2)), (p += 1)
        else if (v === We && t.charCodeAt(p + 1) === qe) {
          let k = p
          for (let x = p + 2; x < t.length; x++)
            if (((g = t.charCodeAt(x)), g === Pe)) x += 1
            else if (g === qe && t.charCodeAt(x + 1) === We) {
              p = x + 1
              break
            }
          let w = t.slice(k, p + 1)
          if (w.charCodeAt(2) === zi) {
          ...
          if (v === ne) {
            ...
            ;(g = u.charCodeAt(u.length - 1)),
              g !== Oe && g !== ne && g !== He && (u += ' ')
          } else if (v === Xt && t.charCodeAt(p + 1) === Xt && u.length === 0) {
            let k = '',
              w = p,
              x = -1
            for (let y = p + 2; y < t.length; y++)
              if (((g = t.charCodeAt(y)), g === Pe)) y += 1
              else if (g === Zt || g === Yt) y = er(t, y, g)
              else if (g === We && t.charCodeAt(y + 1) === qe) {
                for (let V = y + 2; V < t.length; V++)
                  if (((g = t.charCodeAt(V)), g === Pe)) V += 1
                  else if (g === qe && t.charCodeAt(V + 1) === We) {
                    y = V + 1
                    break
                  }
              } else if (x === -1 && g === _i) x = u.length + y - w
              ...
              else if ((g === bt || t.length - 1 === y) && k.length === 0) {
                ;(p = y - 1), (u += t.slice(w, y))
                break
              } else
                (g === Qt || g === Di || g === bt) &&
            ...
            let k = s.pop() ?? null
            k === null && a && e.push(a), (a = k), (u = ''), (d = null)
          } else if (v === At) (c += ')'), (u += '(')
          else if (v === Qt) {
    ...
    if (u.charCodeAt(0) === yt) {
      let p = _e(u)
      i && ((p.src = [i, m, t.length]), (p.dst = [i, m, t.length])), e.push(p)
    }
    if (c.length > 0 && a) {
      if (a.kind === 'rule')
  ...
  function er(t, r, i) {
    ...
    for (let o = r + 1; o < t.length; o++)
      if (((e = t.charCodeAt(o)), e === Pe)) o += 1
      else {
        if (e === i) return o
        if (
          e === Ge &&
          (t.charCodeAt(o + 1) === ne ||
            (t.charCodeAt(o + 1) === Ye && t.charCodeAt(o + 2) === ne))
        )
          throw new Error(
            `Unterminated string: ${t.slice(r, o + 1) + String.fromCharCode(i)}`
          )
        if (e === ne || (e === Ye && t.charCodeAt(o + 1) === ne))
          throw new Error(
            `Unterminated string: ${t.slice(r, o) + String.fromCharCode(i)}`
          )
      }
    return r
  }
    ...
    keysInNamespaces(r) {
      ...
      for (let e of r) {
        ...
        for (let s of this.values.keys())
          s.startsWith(o) &&
            s.indexOf('--', 2) === -1 &&
            (tr(s, e) || i.push(s.slice(o.length)))
      }
      return i
    }
    get(r) {
...
`
  ...
  function G(t, r = []) {
    return t.charCodeAt(0) === Wi ? _e(t, r) : B(t, r)
  }
  function l(t, r, i = !1) {
    ...
    function p(k, w, x = {}, $ = 0) {
      if (k.kind === 'declaration') {
        ...
        if (k.value.includes('var('))
          if (x.theme && k.property[0] === '-' && k.property[1] === '-')
            for (let y of Qe(k.value)) g.get(y).add(k.property)
          else r.trackUsedVariables(k.value)
        if (k.property === 'animation') for (let y of pr(k.value)) u.add(y)
        i & 2 && k.value.includes('color-mix(') && a.get(w).add(k), w.push(k)
      } else if (k.kind === 'rule')
        if (k.selector === '&')
          for (let y of k.nodes) {
            let V = []
            p(y, V, x, $ + 1), V.length > 0 && w.push(...V)
          }
        else {
          let y = { ...k, nodes: [] }
          for (let V of k.nodes) p(V, y.nodes, x, $ + 1)
          y.nodes.length > 0 && w.push(y)
        }
        ...
        if (i & 1) {
          let V = k.params,
            O = null,
            U = !1
          for (let z of k.nodes)
            z.kind === 'declaration' &&
              (z.property === 'initial-value'
                ? (O = z.value)
                : z.property === 'inherits' && (U = z.value === 'true'))
          let R = l(V, O ?? 'initial')
          ;(R.src = k.src), U ? c.push(R) : m.push(R)
        }
        o.add(k.params)
        let y = { ...k, nodes: [] }
        for (let V of k.nodes) p(V, y.nodes, x, $ + 1)
        ...
        let y = { ...k, nodes: [] }
        for (let V of k.nodes) p(V, y.nodes, x, $ + 1)
        k.name === '@keyframes' && x.theme && d.add(y),
          (y.nodes.length > 0 ||
            y.name === '@layer' ||
            y.name === '@charset' ||
            y.name === '@custom-media' ||
        ...
        for (let y of k.nodes) p(y, w, { ...x, ...k.context }, $)
      } else k.kind === 'comment' && w.push(k)
    }
    let v = []
    for (let k of t) p(k, v, {}, 0)
    e: for (let [k, w] of s)
      for (let x of w) {
        if (mr(x.property, r.theme, g)) {
          if (x.property.startsWith(r.theme.prefixKey('--animate-')))
            for (let V of pr(x.value)) u.add(V)
          continue
        }
        let y = k.indexOf(x)
        if ((k.splice(y, 1), k.length === 0)) {
          let V = qi(v, (O) => O.kind === 'rule' && O.nodes === k)
      ...
      for (let [k, w] of a)
        for (let x of w) {
          ...
          let y = q(x.value),
            V = !1
          if (
            (ee(y, (R, { replaceWith: z }) => {
              if (R.kind !== 'function' || R.value !== 'color-mix') return
              let _ = !1,
                H = !1
              if (
                (ee(R.nodes, (j, { replaceWith: W }) => {
                  if (
                    j.kind == 'word' &&
                  ...
                  do {
                    ...
                    oe.startsWith('var(') ? (J = q(oe)[0]) : (J = null)
                  } while (J)
                  W({ kind: 'word', value: oe })
                }),
                _ || H)
              ) {
                let j = R.nodes.findIndex(
                  (J) => J.kind === 'separator' && J.value.trim().includes(',')
                )
                if (j === -1) return
                let W = R.nodes.length > j ? R.nodes[j + 1] : null
                if (!W) return
                z(W)
              } else if (V) {
                let j = R.nodes[2]
            ...
            continue
          let O = { ...x, value: Z(y) },
            U = G('@supports (color: color-mix(in lab, red, red))', [x])
          ;(U.src = x.src), k.splice($, 1, O, U)
        }
    if (i & 1) {
      let k = []
      if (c.length > 0) {
      ...
      if (m.length > 0) {
        let w = G('*, ::before, ::after, ::backdrop', m)
...
`),
  ...
  function* wr(t, r) {
    ...
    } else m = yr(a, (g) => r.utilities.has(g, 'functional'))
    for (let [g, p] of m) {
      let v = {
        kind: 'functional',
        root: g,
  ...
  function xr(t, r) {
    ...
    if (
      ...
      if (r.value.kind === 'arbitrary') {
        if (r.value !== null) {
          let o = Rt(r.value.value),
            s = o ? r.value.value.slice(4, -1) : r.value.value,
            [a, d] = o ? ['(', ')'] : ['[', ']']
          r.value.dataType
            ? (e += `-${a}${r.value.dataType}:${$e(s)}${d}`)
            : (e += `-${a}${$e(s)}${d}`)
        }
  ...
  function rt(t) {
    ...
    if (t.kind === 'arbitrary') return `[${$e(Qi(t.selector))}]`
    let r = ''
  ...
  var to = new Set([
    ...
    ro = /^(rgba?|hsla?|hwb|color|(ok)?(lab|lch)|light-dark|color-mix)\(/i
  function Cr(t) {
    return t.charCodeAt(0) === 35 || ro.test(t) || to.has(t.toLowerCase())
  }
  var io = {
    color: Cr,
    length: it,
  ...
  function Y(t, r) {
    ...
    for (let i of r) if (io[i]?.(t)) return i
    return null
  }
  var oo = /^url\(.*\)$/
  function Sr(t) {
  ...
  var lo = /^(?:element|image|cross-fade|image-set)\(/,
  ...
  var de = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/,
    mo = new RegExp(`^${de.source}$`)
  function Nr(t) {
    return mo.test(t) || Ue(t)
  }
  var go = new RegExp(`^${de.source}%$`)
  function Pt(t) {
    return go.test(t) || Ue(t)
  }
  var ho = new RegExp(`^${de.source}s*/s*${de.source}$`)
  function ko(t) {
    return ho.test(t) || Ue(t)
  }
  var vo = [
      'cm',
      'mm',
    ...
    wo = new RegExp(`^${de.source}(${vo.join('|')})$`)
  function it(t) {
    return wo.test(t) || Ue(t)
  }
  function bo(t) {
    let r = 0
    for (let i of D(t, ' ')) {
  ...
  var xo = ['deg', 'rad', 'grad', 'turn'],
    Ao = new RegExp(`^${de.source}(${xo.join('|')})$`)
  function Co(t) {
    return Ao.test(t)
  }
  ...
  var $o = new Set(['inset', 'inherit', 'initial', 'revert', 'unset']),
    Vr = /^-?(\d+|\.\d+)(.*?)$/g
  function ze(t, r) {
    return D(t, ',')
      .map((e) => {
        e = e.trim()
        let o = D(e, ' ').filter((c) => c.trim() !== ''),
          s = null,
          a = null,
          d = null
        for (let c of o)
  ...
  function Pr(t) {
    ...
    function i(n, f) {
      function* h(b) {
        for (let C of t.keysInNamespaces(b))
          yield C.replace(Rr, (P, N, E) => `${N}.${E}`)
      }
      let A = [
        '1/2',
        '1/3',
      ...
      r.suggest(n, () => {
        ...
        for (let C of f()) {
          if (typeof C == 'string') {
            b.push({ values: [C], modifiers: [] })
            continue
          }
          let P = [...(C.values ?? []), ...h(C.valueThemeKeys ?? [])],
            N = [...(C.modifiers ?? []), ...h(C.modifierThemeKeys ?? [])]
          C.supportsFractions && P.push(...A),
            C.hasDefaultValue && P.unshift(null),
            b.push({
    ...
    function e(n, f) {
      r.static(n, () =>
        f.map((h) => (typeof h == 'function' ? h() : l(h[0], h[1])))
      )
    }
    function o(n, f) {
      function h({ negative: A }) {
        return (b) => {
          ...
          if (b.value)
            if (b.value.kind === 'arbitrary') {
              ...
              if (
                ...
                C === null && f.supportsFractions && b.value.fraction)
              ) {
                let [N, E] = D(b.value.fraction, '/')
                if (!T(N) || !T(E)) return
                C = `calc(${b.value.fraction} * 100%)`
              }
              if (C === null && A && f.handleNegativeBareValue) {
                if (
                  ((C = f.handleNegativeBareValue(b.value)),
                  !C?.includes('/') && b.modifier)
                )
                  return
          ...
          if (C !== null) return f.handle(A ? `calc(${C} * -1)` : C, P)
        }
      }
    ...
    function a(
      ...
      f,
      h,
      { supportsNegative: A = !1, supportsFractions: b = !1 } = {}
    ) {
    ...
    function g({ negative: n }) {
      return (f) => {
        ...
        if (f.value.kind === 'arbitrary') {
          h = f.value.value
          let A = f.value.dataType ?? Y(h, ['angle', 'vector'])
    ...
    let p = () => I([S('--tw-pan-x'), S('--tw-pan-y'), S('--tw-pinch-zoom')])
    ...
    let v = () => I([S('--tw-scroll-snap-strictness', 'proximity', '*')])
    ...
    for (let [n, f] of [
      ...
      a(n, ['--scroll-margin', '--spacing'], (h) => [l(f, h)], {
        supportsNegative: !0,
      })
    for (let [n, f] of [
      ...
      a(n, ['--scroll-padding', '--spacing'], (h) => [l(f, h)])
    ...
    for (let [n, f] of [
      ...
      e(
        ...
        o(n, { themeKeys: ['--radius'], handle: (h) => f.map((A) => l(A, h)) })
    e('border-solid', [
      ...
      ])
    {
        ...
        r.functional(h, (b) => {
          ...
          if (b.value.kind === 'arbitrary') {
            ...
            switch (
              ...
              default:
                return (
                  (C = X(C, b.modifier, t)), C === null ? void 0 : A.color(C)
                )
            }
          }
          {
            let C = te(b, t, ['--border-color', '--color'])
            if (C) return A.color(C)
          }
          {
            if (b.modifier) return
            let C = t.resolve(b.value.value, ['--border-width'])
            if (C) {
              let P = A.width(C)
              return P ? [n(), ...P] : void 0
            }
          ...
          i(h, () => [
            {
              ...
              modifiers: Array.from({ length: 21 }, (b, C) => `${C * 5}`),
              hasDefaultValue: !0,
            },
            {
              values: ['0', '2', '4', '8'],
      ...
      var _ = f
      let n = () => I([S('--tw-border-style', 'solid')])
      f('border', {
        width: (h) => [
    ...
    r.functional('bg', (n) => {
      if (n.value) {
        ...
        {
          let f = te(n, t, ['--background-color', '--color'])
        ...
        if (h.value) {
          if (h.value.kind === 'arbitrary') {
            ...
            switch (
              ...
              default:
                return (
                  (A = X(A, h.modifier, t)), A === null ? void 0 : f.color(A)
                )
            }
          }
          {
    ...
    w('from', {
      ...
      r.functional('mask', (n) => {
        ...
        switch (
          n.value.dataType ??
          Y(f, ['image', 'percentage', 'position', 'bg-size', 'length', 'url'])
        ) {
          case 'percentage':
          case 'position':
        ...
        color(A) {
          ...
          for (let C of ['top', 'right', 'bottom', 'left'])
            h[C] &&
              ...
              b.push(
                I([
                  S(`--tw-mask-${C}-from-position`, '0%'),
                  S(`--tw-mask-${C}-to-position`, '100%'),
                  S(`--tw-mask-${C}-from-color`, 'black'),
                  S(`--tw-mask-${C}-to-color`, 'transparent'),
                ])
              ),
              b.push(l(`--tw-mask-${C}-${f}-color`, A)))
          return b
        },
        position(A) {
          let b = [
          ...
          for (let C of ['top', 'right', 'bottom', 'left'])
            h[C] &&
              ...
              b.push(l(`--tw-mask-${C}-${f}-position`, A)))
          return b
        },
      })
    }
      ...
      r.functional('stroke', (n) => {
        if (n.value) {
          if (n.value.kind === 'arbitrary') {
            ...
            switch (
              n.value.dataType ??
              Y(f, ['color', 'number', 'length', 'percentage'])
            ) {
              case 'number':
              case 'length':
              case 'percentage':
              ...
              default:
                return (
                  (f = X(n.value.value, n.modifier, t)),
                  f === null ? void 0 : [l('stroke', f)]
                )
            }
          }
          {
            let f = te(n, t, ['--stroke', '--color'])
    ...
    e('text-left', [['text-align', 'left']]),
      ...
      r.functional('font', (n) => {
        if (!(!n.value || n.modifier)) {
          if (n.value.kind === 'arbitrary') {
            ...
            switch (
              n.value.dataType ??
              Y(f, ['number', 'generic-name', 'family-name'])
            ) {
              case 'generic-name':
              case 'family-name':
      ...
      r.functional('decoration', (n) => {
        if (n.value) {
          ...
          {
            let f = te(n, t, ['--text-decoration-color', '--color'])
      ...
      })
    {
      ...
      r.functional('filter', (b) => {
        if (!b.modifier) {
          if (b.value === null) return [h(), l('filter', n)]
          if (b.value.kind === 'arbitrary') return [l('filter', b.value.value)]
        ...
        o('blur', {
          themeKeys: ['--blur'],
          handle: (b) => [h(), l('--tw-blur', `blur(${b})`), l('filter', n)],
        }),
        ...
        o('sepia', {
          ...
          handleBareValue: ({ value: b }) => (T(b) ? `${b}%` : null),
          defaultValue: '100%',
          handle: (b) => [h(), l('--tw-sepia', `sepia(${b})`), l('filter', n)],
        }),
        o('backdrop-sepia', {
        ...
        r.functional('drop-shadow', (b) => {
          ...
          if (
            (b.modifier &&
              (b.modifier.kind === 'arbitrary'
                ? (C = b.modifier.value)
                : T(b.modifier.value) && (C = `${b.modifier.value}%`)),
            !b.value)
          ) {
            let P = t.get(['--drop-shadow']),
              N = t.resolve(null, ['--drop-shadow'])
          ...
          if (b.value.kind === 'arbitrary') {
            let P = b.value.value
            switch (b.value.dataType ?? Y(P, ['color'])) {
              case 'color':
                return (
                  (P = X(P, b.modifier, t)),
                  P === null
          ...
          {
            let P = t.get([`--drop-shadow-${b.value.value}`]),
              N = t.resolve(b.value.value, ['--drop-shadow'])
            if (P && N)
              return b.modifier && !C
                ? void 0
                : C
          ...
          {
            let P = te(b, t, ['--drop-shadow-color', '--color'])
            if (P)
              return P === 'inherit'
                ? [
                    h(),
        ...
        i('backdrop-opacity', () => [
          {
            values: Array.from({ length: 21 }, (b, C) => `${C * 5}`),
          ...
          r.functional('duration', (A) => {
            ...
            if (
              (A.value.kind === 'arbitrary'
                ? (b = A.value.value)
                : ((b = t.resolve(A.value.fraction ?? A.value.value, [
                    '--transition-duration',
                  ])),
                  b === null && T(A.value.value) && (b = `${A.value.value}ms`)),
              b !== null)
            )
              return [h(), l('--tw-duration', b), l('transition-duration', b)]
          })
      }
      i('delay', () => [
        {
    ...
    {
      let n = () => I([S('--tw-outline-style', 'solid')])
      r.static('outline-hidden', () => [
        ...
        r.functional('outline', (f) => {
          ...
          {
            let h = te(f, t, ['--outline-color', '--color'])
    ...
    o('opacity', {
      themeKeys: ['--opacity'],
      handleBareValue: ({ value: n }) => (ot(n) ? `${n}%` : null),
              ...
              case 'relative-size': {
                if (n.modifier) {
                  ...
                  return (
                    ...
                    A ? [l('font-size', f), l('line-height', A)] : null
                  )
                }
              ...
              if (n.modifier) {
                let b =
                  n.modifier.kind === 'arbitrary'
                    ? n.modifier.value
                    : t.resolve(n.modifier.value, ['--leading'])
                if (!b && xe(n.modifier.value)) {
                  let P = t.resolve(null, ['--spacing'])
                  if (!P) return null
                  b = `calc(${P} * ${n.modifier.value})`
                }
    ...
    e('text-shadow-initial', [z, ['--tw-text-shadow-color', 'initial']]),
      r.functional('text-shadow', (n) => {
        ...
        if (
          (n.modifier &&
            (n.modifier.kind === 'arbitrary'
              ? (f = n.modifier.value)
              : T(n.modifier.value) && (f = `${n.modifier.value}%`)),
          !n.value)
        ) {
        ...
        switch (n.value.value) {
          case 'none':
            return n.modifier ? void 0 : [z(), l('text-shadow', 'none')]
          case 'inherit':
            return n.modifier
              ? void 0
              : [z(), l('--tw-text-shadow-color', 'inherit')]
        }
        {
      ...
      ])
    {
      ...
      e('shadow-initial', [h, ['--tw-shadow-color', 'initial']]),
        r.functional('shadow', (N) => {
          ...
          if (N.value.kind === 'arbitrary') {
            let K = N.value.value
            switch (N.value.dataType ?? Y(K, ['color'])) {
              case 'color':
                return (
                  (K = X(K, N.modifier, t)),
                  K === null
                    ...
                    : [
                        h(),
                        l('--tw-shadow-color', Q(K, 'var(--tw-shadow-alpha)')),
                      ]
                )
              default:
                return [
          ...
          switch (N.value.value) {
            case 'none':
              return N.modifier
                ? void 0
                : [h(), l('--tw-shadow', f), l('box-shadow', n)]
            case 'inherit':
              return N.modifier
                ? void 0
          ...
          {
            let K = t.get([`--shadow-${N.value.value}`])
            if (K)
              return [
                h(),
                l('--tw-shadow-alpha', E),
          ...
          {
            let K = te(N, t, ['--box-shadow-color', '--color'])
            if (K)
              return [
                h(),
                l('--tw-shadow-color', Q(K, 'var(--tw-shadow-alpha)')),
        ...
        r.functional('inset-shadow', (N) => {
          ...
          switch (N.value.value) {
            case 'none':
              return N.modifier
                ? void 0
                : [h(), l('--tw-inset-shadow', f), l('box-shadow', n)]
            case 'inherit':
              return N.modifier
                ? void 0
          ...
          {
            let K = t.get([`--inset-shadow-${N.value.value}`])
            if (K)
              return [
                h(),
                l('--tw-inset-shadow-alpha', E),
      ...
      r.functional('ring', (N) => {
        if (!N.value) {
          ...
          return [h(), l('--tw-ring-shadow', b(E)), l('box-shadow', n)]
        }
        if (N.value.kind === 'arbitrary') {
          let E = N.value.value
          switch (N.value.dataType ?? Y(E, ['color', 'length'])) {
            case 'length':
              return N.modifier
                ? void 0
                : [h(), l('--tw-ring-shadow', b(E)), l('box-shadow', n)]
            default:
              return (
                (E = X(E, N.modifier, t)),
        ...
        {
          let E = te(N, t, ['--ring-color', '--color'])
          if (E) return [l('--tw-ring-color', E)]
        }
        {
          if (N.modifier) return
          let E = t.resolve(N.value.value, ['--ring-width'])
        ...
        r.functional('inset-ring', (N) => {
          if (!N.value)
            return N.modifier
              ? void 0
              : [h(), l('--tw-inset-ring-shadow', C('1px')), l('box-shadow', n)]
          if (N.value.kind === 'arbitrary') {
            let E = N.value.value
            switch (N.value.dataType ?? Y(E, ['color', 'length'])) {
              case 'length':
                return N.modifier
                  ? void 0
                  : [h(), l('--tw-inset-ring-shadow', C(E)), l('box-shadow', n)]
              default:
                return (
                  (E = X(E, N.modifier, t)),
      ...
      r.functional('ring-offset', (N) => {
        if (N.value) {
          ...
          {
            let E = t.resolve(N.value.value, ['--ring-offset-width'])
            if (E)
              return N.modifier
                ? void 0
                : [
          ...
          {
            let E = te(N, t, ['--ring-offset-color', '--color'])
...
`)
                  ...
                  let p = '^'.repeat(Z([u]).length),
                    v = Z([m]).indexOf(g),
                    k = ['```css', Z([a]), ' '.repeat(v) + p, '```'].join(`
`)
                  console.warn(k)
                }
            }),
    ...
    for (let e of r.nodes) {
      ...
      if (
        ...
        if (o.endsWith('-*')) {
          ...
          let a = [s.shift()],
            d = i.theme.resolveWith(t.value, a, s)
          if (d) {
            let [, u = {}] = d
            {
              let c = u[s.pop()]
  ...
  function pe(t, r, i, e, o = '') {
    ...
    return s
      ? [
          l(t, d(ze(r, e))),
          G('@supports (color: lab(from red l a b))', [l(t, d(a))]),
        ]
      : [l(t, d(a))]
  }
  function nt(t, r, i, e, o = '') {
    let s = !1,
      a = D(r, ',')
        .map((d) =>
          ze(d, (u) =>
  ...
  var Dt = { '--alpha': To, '--spacing': Ro, '--theme': Po, theme: Oo }
  function To(t, r, i, ...e) {
    let [o, s] = D(i, '/').map((a) => a.trim())
    if (!o || !s)
      throw new Error(
    ...
    return (
      ee(e, (o, { replaceWith: s }) => {
        if (o.kind === 'function' && o.value in Dt) {
          let a = D(Z(o.nodes).trim(), ',').map((u) => u.trim()),
            d = Dt[o.value](i, r, ...a)
          return s(q(d))
        }
      }),
  ...
  var Do = /^\d+\/\d+$/
  function Dr(t) {
    let r = new M((o) => ({ name: o, utility: o, fraction: !1, modifiers: [] }))
    ...
    return i.sort((o, s) => at(o.name, s.name)), zo(i)
  }
  function zo(t) {
    let r = [],
      i = null,
    ...
    for (let a of t) {
      ...
      i || ((i = { utility: d, items: [] }), e.set(d, i)),
        d !== i.utility &&
          (r.push(i), (i = { utility: d, items: [] }), e.set(d, i)),
  ...
  function zr(t) {
    ...
    for (let [e, o] of t.variants.entries()) {
      let d = function ({ value: u, modifier: c } = {}) {
        ...
        if (Ee(p, g, t.variants) === null) return []
        let v = []
        return (
          Xe(p.nodes, (k, { path: w }) => {
            if (
  ...
  var Lt = class {
    ...
    set(r, { kind: i, applyFn: e, compounds: o, compoundsWith: s, order: a }) {
      ...
      d
        ? Object.assign(d, { kind: i, applyFn: e, compounds: o })
        : (a === void 0 &&
  ...
  function jr(t) {
      ...
      if (
        (L([c], (p, { path: v }) => {
          ...
          let k = [],
            w = []
          for (let $ of v)
            $.kind === 'at-rule' ? k.push($) : $.kind === 'rule' && w.push($)
    ...
    i('first', ['&:first-child']),
      ...
      r.static('hover', (c) => {
        c.nodes = [B('&:hover', [F('@media', '(hover: hover)', c.nodes)])]
      }),
      i('focus', ['&:focus']),
      ...
      r.functional('aria', (c, m) => {
        ...
        m.value.kind === 'arbitrary'
          ? (c.nodes = [B(`&[aria-${Kr(m.value.value)}]`, c.nodes)])
          : (c.nodes = [B(`&[aria-${m.value.value}="true"]`, c.nodes)])
      }),
      r.suggest('aria', () => [
        'busy',
        'checked',
      ...
      r.functional('data', (c, m) => {
        if (!m.value || m.modifier) return null
        c.nodes = [B(`&[data-${Kr(m.value.value)}]`, c.nodes)]
      }),
      r.functional('nth', (c, m) => {
        if (
          ...
          return null
        c.nodes = [B(`&:nth-child(${m.value.value})`, c.nodes)]
      }),
      r.functional('nth-last', (c, m) => {
        if (
          ...
          return null
        c.nodes = [B(`&:nth-last-child(${m.value.value})`, c.nodes)]
      }),
      r.functional('nth-of-type', (c, m) => {
        if (
          ...
          return null
        c.nodes = [B(`&:nth-of-type(${m.value.value})`, c.nodes)]
      }),
      r.functional('nth-last-of-type', (c, m) => {
        if (
          ...
          return null
        c.nodes = [B(`&:nth-last-of-type(${m.value.value})`, c.nodes)]
      }),
      r.functional(
        'supports',
        (c, m) => {
      ...
      var u = c
      {
        let m = t.namespace('--breakpoint'),
          g = new M((p) => {
            switch (p.kind) {
              case 'static':
                return t.resolveValue(p.root, ['--breakpoint']) ?? null
              case 'functional': {
                ...
                return (
                  p.value.kind === 'arbitrary'
                    ? (v = p.value.value)
                    : p.value.kind === 'named' &&
                      (v = t.resolveValue(p.value.value, ['--breakpoint'])),
        ...
        r.group(
          ...
          r.suggest('min', () => Array.from(m.keys()).filter((p) => p !== null))
      }
      {
              ...
              case 'functional': {
                ...
                return (
                  p.value.kind === 'arbitrary'
                    ? (v = p.value.value)
                    : p.value.kind === 'named' &&
                      (v = t.resolveValue(p.value.value, ['--container'])),
                  !v || v.includes('var(') ? null : v
                )
              }
              case 'static':
      ...
      d = {
        ...
        candidatesToCss(u) {
          ...
          for (let m of u) {
            ...
            ;(p = be(p, d, 0)),
              p.length === 0 || g ? c.push(null) : c.push(le(p))
          }
          return c
        },
        getClassOrder(u) {
        ...
        resolveThemeValue(u, c = !0) {
          ...
          let p = t.resolve(null, [u], c ? 1 : 0) ?? void 0
          return g && p ? Q(p, g) : p
        },
  ...
  function he(t, r, { onInvalidCandidate: i, respectImportant: e } = {}) {
    let o = new Map(),
      s = [],
      a = new Map()
    for (let c of t) {
          ...
          a.get(k).add(g),
            L(g.nodes, (w) => {
              if (!(w.kind !== 'at-rule' || w.name !== '@apply')) {
                o.add(g)
                for (let x of Wr(w, r)) s.get(g).add(x)
              }
            })
          return
        }
...
${le([v])}`))
    ...
    for (let g of u)
      'nodes' in g &&
        L(g.nodes, (p, { replaceWith: v }) => {
          if (p.kind !== 'at-rule' || p.name !== '@apply') return
          let k = p.params.split(/(\s+)/g),
            w = {},
            x = 0
          for (let [$, y] of k.entries())
            $ % 2 === 0 && (w[y] = x), (x += y.length)
          {
            let $ = Object.keys(w),
              y = he($, r, {
                respectImportant: !1,
                  ...
                  if (z.length > 1) {
                    ...
                    if (r.candidatesToCss([_])[0]) {
                      let H = r.candidatesToCss(
                          z.map((W) => `${W}:[--tw-variant-check:1]`)
                        ),
                        j = z.filter((W, J) => H[J] === null)
                      if (j.length > 0) {
                        if (j.length === 1)
                          throw new Error(
                            `Cannot apply utility class \`${R}\` because the ${j.map(
                              (W) => `\`${W}\``
                          ...
                          )
                        {
                          ...
                          throw new Error(
                            `Cannot apply utility class \`${R}\` because the ${W.format(
                              j.map((J) => `\`${J}\``)
              ...
              V = p.src,
              O = y.astNodes.map((R) => {
                let z = y.nodeSorting.get(R)?.candidate,
                  _ = z ? w[z] : void 0
                if (((R = structuredClone(R)), !V || !z || _ === void 0))
                  return (
                    L([R], (j) => {
                      j.src = V
                    }),
              ...
              U = []
            for (let R of O)
              if (R.kind === 'rule') for (let z of R.nodes) U.push(z)
              else U.push(R)
            v(U)
          }
        })
  ...
  async function It(t, r, i, e = 0, o = !1) {
    let s = 0,
      a = []
    return (
      L(t, (d, { replaceWith: u }) => {
          ...
          return (
            a.push(
              (async () => {
                ...
                await It(x, w.base, i, e + 1, o),
                  (k.nodes = Io(d, [ue({ base: w.base }, x)], g, p, v))
              })()
            ),
            u(k),
            1
  ...
  function ut(t) {
    ...
    for (let r of t) if (!Mo.test(r)) return null
    return t
  ...
  function Hr(t, r = [], i) {
    for (let e of Reflect.ownKeys(t)) {
      ...
      if (a !== 1) {
        if (a === 2) return 2
        if (!(!Array.isArray(o) && typeof o != 'object') && Hr(o, s, i) === 2)
          return 2
      }
    }
  }
    ...
    return function (o, s) {
      ...
      let u = (() => {
        ...
        if (p !== null && typeof p == 'object' && !Array.isArray(p)) {
          ...
          for (let k in m)
            k !== '__CSS_VALUES__' &&
              ((p?.__CSS_VALUES__?.[k] & 4 && Gr(v, k.split('-')) !== void 0) ||
                (v[ve(k)] = m[k]))
          return v
        }
  ...
  function qo(t, r) {
    ...
    for (let [m, g] of s) {
      ...
      ;(k = k.replace(/-([a-z])/g, (w, x) => x.toUpperCase())),
        o.get(v === '' ? null : v).set(k, [g, t.getOptions(`--${i}${m}`)])
    }
    let d = t.getOptions(`--${i}`)
    for (let [m, g] of o) {
      let p = e.get(m)
      if (typeof p != 'string') continue
      let v = {},
        k = {}
      for (let [w, [x, $]] of g) (v[w] = x), (k[w] = $)
      e.set(m, [p, v]), a.set(m, [d, k])
    }
    let u = {},
      c = {}
    for (let [m, g] of e) Yr(u, [m ?? 'DEFAULT'], g)
    for (let [m, g] of a) Yr(c, [m ?? 'DEFAULT'], g)
...
`
  ...
  function Ft({
    ...
    let a = {
      ...
      addVariant(d, u) {
        if (!st.test(d))
          throw new Error(
            `\`addVariant('${d}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`
          )
        if (typeof u == 'string') {
        ...
        typeof u == 'string' || Array.isArray(u)
          ? t.variants.static(
              d,
              (m) => {
                m.nodes = si(u, m.nodes)
              },
              { compounds: Ae(typeof u == 'string' ? [u] : u) }
            )
          : typeof u == 'object' && t.variants.fromAst(d, ce(u))
      },
      matchVariant(d, u, c) {
        function m(p, v, k) {
          ...
          (p, v) => {
            ...
            if (c && typeof c.sort == 'function')
              return c.sort(
                ...
                { value: $, modifier: v.modifier?.value ?? null }
              )
            let y = g.indexOf(k),
              V = g.indexOf(w)
            return (
      ...
      addUtilities(d) {
        ...
        u = u.flatMap(([m, g]) => D(m, ',').map((p) => [p.trim(), g]))
        let c = new M(() => [])
        for (let [m, g] of u) {
        ...
        for (let [m, g] of c)
          t.theme.prefix &&
            ...
            t.utilities.static(m, (p) => {
              ...
              return ui(v, m, p.raw), (e.current |= Ke(v, t)), v
            })
      },
      matchUtilities(d, u) {
        let c = u?.type ? (Array.isArray(u?.type) ? u.type : [u.type]) : ['any']
        for (let [g, p] of Object.entries(d)) {
            ...
            return (w) => {
              if (
                ...
                ((w.value.dataType && !c.includes(w.value.dataType)) ||
                  (!w.value.dataType && !Y(w.value.value, c)))
              )
                return
                ...
                y = !1
              {
                ...
                x &&
                  ...
                  w.value
                    ? w.value.kind === 'arbitrary'
                      ? ($ = w.value.value)
                      : w.value.fraction && U[w.value.fraction]
                      ? (($ = U[w.value.fraction]), (y = !0))
                      : U[w.value.value]
                      ? ($ = U[w.value.value])
                      : U.__BARE_VALUE__ &&
                        (($ = U.__BARE_VALUE__(w.value) ?? null),
                        (y =
                          (w.value.fraction !== null && $?.includes('/')) ??
                          !1))
                    : ($ = U.DEFAULT ?? null)
              }
              if ($ === null) return
              let V
              {
                let U = u?.modifiers ?? null
                w.modifier
                  ? U === 'any' || w.modifier.kind === 'arbitrary'
                    ? (V = w.modifier.value)
                    : U?.[w.modifier.value]
                    ? (V = U[w.modifier.value])
                    : x && !Number.isNaN(Number(w.modifier.value))
                    ? (V = `${w.modifier.value}%`)
                    : (V = null)
                  : (V = null)
              }
              if (w.modifier && V === null && !y)
                return w.value?.kind === 'arbitrary' ? null : void 0
              x && V !== null && ($ = Q($, V)), k && ($ = `calc(${$} * -1)`)
              let O = ce(p($, { modifier: V }))
              return ui(O, g, w.raw), (e.current |= Ke(O, t)), O
            }
          }
          var m = v
          if (!ai.test(g))
          ...
          u?.supportsNegativeValues &&
            t.utilities.functional(`-${g}`, v({ negative: !0 }), { types: c }),
            t.utilities.functional(g, v({ negative: !1 }), { types: c }),
  ...
  function Mt(t, { config: r, base: i, path: e, reference: o, src: s }) {
    let a = []
    ...
    for (let c of r.presets ?? [])
      Mt(t, { path: e, base: i, config: c, reference: o, src: s })
    for (let c of a)
      t.plugins.push(c),
        c.config &&
          Mt(t, {
    ...
    for (let c of u)
      t.content.files.push(typeof c == 'object' ? c : { base: i, pattern: c })
    t.configs.push(r)
  }
  function un(t) {
    let r = new Set(),
      i = ft(t.design, () => t.theme, o),
      e = Object.assign(i, { theme: i, colors: pt })
    function o(s) {
  ...
  function cn({ center: t, padding: r, screens: i }, e) {
    let o = [],
      s = null
    if (
      ...
      for (let [d, u] of Object.entries(i)) {
        ...
        s.set(d, F('@media', `(width >= ${u})`, [l('max-width', u)]))
      }
    }
  ...
  function hi({ addVariant: t, config: r }) {
    ...
    if (o.length !== 0) {
      ...
      r.variants.compareFns = new Map(
        Array.from(r.variants.compareFns).map(
          ([a, d]) => (a > e && (a += o.length), [a, d])
        )
      )
      for (let [a, d] of o.entries()) d(e + a + 1)
    }
  }
  function fn(t) {
  ...
  async function yi({
    ...
    let s = 0,
      a = [],
      d = []
    L(i, (g, { parent: p, replaceWith: v, context: k }) => {
      if (g.kind === 'at-rule') {
        if (g.name === '@plugin') {
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`)
    ...
    if (
      ((t.resolveThemeValue = function (p, v) {
        return p.startsWith('--')
          ? u(p, v)
          : ((s |= bi({
              designSystem: t,
  ...
  function bi({
    ...
    let a = 0,
      ...
      { resolvedConfig: c } = Bt(t, [
        { config: mi(t.theme), base: r, reference: !0, src: void 0 },
        ...u,
        { config: { plugins: [hi] }, base: r, reference: !0, src: void 0 },
      ]),
      { resolvedConfig: m, replacedThemeKeys: g } = Bt(t, u),
      p = {
        designSystem: t,
        ast: i,
        resolvedConfig: c,
      ...
      v = Ft({ ...p, referenceMode: !1, src: void 0 }),
      k = t.resolveThemeValue
    t.resolveThemeValue = function (x, $) {
      if (x[0] === '-' && x[1] === '-') return k(x, $)
      let y = v.theme(x, void 0)
      if (Array.isArray(y) && y.length === 2) return y[0]
      if (Array.isArray(y)) return y.join(', ')
      if (typeof y == 'string') return y
    }
    for (let { handler: w, reference: x, src: $ } of c.plugins) {
      let y = Ft({ ...p, referenceMode: x ?? !1, src: $ })
      w(y)
    }
    if (
      (qr(t, m, g),
    ...
    if (
      ...
      let w = c.important
      L(i, (x, { replaceWith: $, parent: y }) => {
        if (
          x.kind === 'at-rule' &&
          !(x.name !== '@tailwind' || x.params !== 'utilities')
        )
          return y?.kind === 'rule' && y.selector === w ? 2 : ($(B(w, [x])), 2)
      })
    }
    for (let w of c.blocklist) t.invalidCandidates.add(w)
...
This feature is not currently supported.`)
  ...
  function Ai({ ast: t }) {
    let r = new M((o) => xi(o.code)),
      i = new M((o) => ({ url: o.file, content: o.code, ignore: !1 })),
...
`)) {
  ...
  function gt(t) {
    ...
    let d = o.slice(1, a),
      u = o.slice(a + 1),
      c
    pn(d) ? (c = mn(d)) : (c = D(d, ',')), (c = c.flatMap((g) => gt(g)))
    let m = gt(u)
    for (let g of m) for (let p of c) i.push(e + p + g)
    return i
  }
  function pn(t) {
    return Ci.test(t)
  ...
  async function wn(
    t,
    { base: r = '', from: i, loadModule: e = hn, loadStylesheet: o = kn } = {}
  ) {
    let s = 0
    ;(t = [ue({ base: r }, t)]), (s |= await It(t, r, o, 0, i !== void 0))
    let a = null,
      d = new Je(),
      u = [],
      c = [],
      ...
      w = [],
      x = null
    L(t, (y, { parent: V, replaceWith: O, context: U }) => {
      if (y.kind === 'at-rule') {
        if (
          y.name === '@tailwind' &&
          ...
          for (let z of R)
            if (z.startsWith('source(')) {
              ...
              x = { base: U.sourceBase ?? U.base, pattern: _.slice(1, -1) }
            }
          ;(g = y), (s |= 16)
        }
        if (y.name === '@utility') {
        ...
        if (y.name === '@source') {
          ...
          if (z) {
            let j = R ? w : k,
              W = D(H, ' ')
            for (let J of W) for (let oe of gt(J)) j.push(oe)
          } else v.push({ base: U.base, pattern: H, negated: R })
          O([])
          return
        }
        if (
          ...
          if (y.nodes.length === 0) {
            ...
            if (_.length === 0 || _.some((W) => W.trim() === ''))
              throw new Error(
                `\`@custom-variant ${R} (${_.join(',')})\` selector is invalid.`
              )
            let H = [],
              j = []
            for (let W of _)
            ...
            u.push((W) => {
              W.variants.static(
                ...
                (J) => {
                  let oe = []
                  j.length > 0 && oe.push(B(j.join(', '), J.nodes))
                  for (let n of H) oe.push(G(n, J.nodes))
                  J.nodes = oe
                },
                { compounds: Ae([...j, ...H]) }
              )
          ...
          for (let _ of R)
            if (_.startsWith('source(')) {
              ...
              _ === 'important'
                ...
                : z.push(_)
          z.length > 0 ? (y.params = z.join(' ')) : R.length > 0 && O(y.nodes)
        }
        if (y.name === '@theme') {
          let [R, z] = vn(y.params)
          if ((U.reference && (R |= 2), z)) {
            if (!gn.test(z))
              throw new Error(
          ...
          return (
            L(y.nodes, (_) => {
              if (_.kind === 'at-rule' && _.name === '@keyframes')
                return d.addKeyframes(_), 1
              if (_.kind === 'comment') return
              if (_.kind === 'declaration' && _.property.startsWith('--')) {
                d.add(ve(_.property), _.value ?? '', R, _.src)
                return
              }
              let H = le([F(y.name, y.params, [_])])
                .split(
                  `
`
                )
...
${H}`)
            ...
            m ? O([]) : ((m = B(':root, :host', [])), (m.src = y.src), O([m])),
            1
          )
        }
      }
    ...
    if ((a && ($.important = a), w.length > 0))
      for (let y of w) $.invalidCandidates.add(y)
    s |= await yi({
      designSystem: $,
      base: r,
      ast: t,
    ...
    if (m) {
      let y = []
      for (let [O, U] of $.theme.entries()) {
        if (U.options & 2) continue
        let R = l(me(O), U.value)
        ;(R.src = U.src), y.push(R)
      }
      let V = $.theme.getKeyframes()
      for (let O of V) t.push(ue({ theme: !0 }, [I([O])]))
      m.nodes = [ue({ theme: !0 }, y)]
    }
    if (p.length > 0) {
      for (let y of p) {
        let V = B('&', y.nodes),
        ...
        for (let V of k)
          if (!i.invalidCandidates.has(V))
            if (V[0] === '-' && V[1] === '-') {
              ...
              ;(w ||= O), (x ||= O)
            } else m.add(V), (w ||= m.size !== $)
        if (!w) return (g ??= be(e, i, r.polyfills)), g
        let y = he(m, i, { onInvalidCandidate: c }).astNodes
        return (
          r.from &&
            L(y, (V) => {
              V.src ??= a.src
          ...
          !x && p === y.length
            ? ((g ??= be(e, i, r.polyfills)), g)
            : ((p = y.length), (a.nodes = y), (g = be(e, i, r.polyfills)), g)
        )
      },
    }
  }
  async function Si(t, r = {}) {
    let i = Se(t, { from: r.from }),
      e = await bn(i, r),
      o = i,
      s = t
    return {
      ...
      build(a) {
        let d = e.build(a)
        return d === o || ((s = le(d, !!r.from)), (o = d)), s
      },
      buildSourceMap() {
        return Ai({ ast: o })
      },
  ...
  var Ni = `@layer theme, base, components, utilities;
...
`
  var Be = { index: Ni, preflight: $i, theme: Vi, utilities: Ei }
  var ht = class {
    start(r) {
  ...
  async function Vn() {
    ...
    let t = document.querySelectorAll(`style[type="${Ri}"]`),
      r = ''
    for (let i of t)
      Pi(i),
        (r +=
...
`)
    if (
      ...
      try {
        kt = await Si(r, { base: '/', loadStylesheet: En, loadModule: Tn })
      } finally {
  ...
  async function Rn(t) {
    ...
    for (let i of document.querySelectorAll('[class]'))
      for (let e of i.classList) qt.has(e) || (qt.add(e), r.add(e))
    ...
    for (let e of t) {
      for (let o of e.addedNodes)
        o.nodeType === Node.ELEMENT_NODE &&
          o.tagName === 'STYLE' &&
          o.getAttribute('type') === Ri &&
          (Pi(o), r++)
      for (let o of e.addedNodes) o.nodeType === 1 && o !== Ht && i++
      e.type === 'attributes' && i++
    }
    if (r > 0) return vt('full')
    if (i > 0) return vt('incremental')
